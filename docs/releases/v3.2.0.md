...
thousand blocks' worth of activity against the wrong epoch. On the live allocations nest after the
change, 266 of 268 epoch boundaries are exact and the two remaining are the open edges; the two fee
fields match the network subgraph 68 of 68 at a pinned block.
