...
option for teams who'd rather not self-host - same binary, their gateway in front._

Repo, install, and the Horizon nest: https://github.com/nightswatchhq/nuthatch
