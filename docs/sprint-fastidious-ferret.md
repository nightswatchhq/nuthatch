...
tests behind it. The weekly subscription allowance also resets on 18 August, so this sprint spends
from the same remaining budget as the audit and release around it. The slack goes into the p0.
