...
| 0022 Distributed scaled mode | **Implemented 2026-07-30** | - (all six §Testing items pass, 39 tests vs live Postgres in CI; compose-up and a true multi-machine run remain open, recorded in prod-readiness §11) | - |
