...
| [0022](0022-distributed-scaled-mode.md) | Distributed scaled mode - read/write planes, writer pool, dynamic placement | 0013, 0019, 0021 | **Accepted - design only, build deferred** (2026-07-21); §0 amendment applied; dependency-gated on 0013-scaled + 0021; **operator-run** distributed infra (not a laptop build) |
