# Treat a list relation's nested filter as a to-one, so `EXISTS` joins on a column the parent does not
# have - answering a query whose semantics the reference endpoint 504s rather than demonstrates.
